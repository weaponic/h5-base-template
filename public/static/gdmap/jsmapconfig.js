//js map
IMAP.Host = "https://ybls1.gaj.sh.gov.cn:25002/jsmap";
//msp服务
IMAP.ApiHost = "https://ybls1.gaj.sh.gov.cn:25001";
//插件的
IMAP.pluginsUrl = "https://ybls1.gaj.sh.gov.cn:25001/as/webapi/js/auth?v=1.0&t=jsmap&ak=ec85d3648154874552835438ac6a02b2&m=";
//栅格图片
IMAP.TileServerUrl = ["https://{s}/v3/tile?z={z}&x={x}&y={y}", ["ybls1.gaj.sh.gov.cn:25333"]]
// 路网地图
IMAP.ROADNET_URL = "https://ybls1.gaj.sh.gov.cn:25333/v3/tile?x={x}&y={y}&z={z}";
...
IMAP.MapConfig = {
    ...
    _MAP_BGIMG_URL: "js/jsmap/backgroundimg.png",
    ...
    _MAP_PANORAMA: {
        ...
        "ROAD_URL": IMAP.ROADNET_URL,//默认路网趣图地址
