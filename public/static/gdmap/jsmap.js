!function (window, document, undefined) {
    ...
    proto.addEventListener = proto.on,
        ...
        L.DomUtil = {
            ...
            addClass: function (t, i) {
                if (t.classList !== undefined) for (var e = L.Util.splitWords(i), n = 0, s = e.length; s > n; n++) t.classList.add(e[n]);
    ...
    L.Browser.touch && !L.Browser.pointer && L.Map.addInitHook("addHandler", "tap", L.Map.Tap),
        ...
        L.Projection.Mercator = {
            ...
            unproject: function (t) {
                for (var i, e = 180 / Math.PI,
                         n = this.R,
                         s = this.R_MINOR / n,
                         o = Math.sqrt(1 - s * s), a = Math.exp(-t.y / n), r = Math.PI / 2 - 2 * Math.atan(a), h = 0, l = .1; 15 > h && Math.abs(l) > 1e-7; h++) i = o * Math.sin(r),
        ...
        L.GridLayer = L.Layer.extend({
            ...
            _setAutoZIndex: function (t) {
                for (var i, e = this.getPane().children, n = -t(-(1 / 0), 1 / 0), s = 0, o = e.length; o > s; s++) i = e[s].style.zIndex,
        ...
        L.Dg.Sv = {
            ...
            unproject: function (t, i) {
                for (var e = 180 / Math.PI,
                         ...
                         o = t.x * e / n,
                         n = s / n,
                         n = Math.sqrt(1 - n * n), s = Math.exp(-t.y / s), a = Math.PI / 2 - 2 * Math.atan(s), r = 15, h = .1; 1e-7 < Math.abs(h) && (r -= 1, r > 0);) h = n * Math.sin(a),
                ...
                if (t) {
                    ...
                    if (t.rules) {
                        for (var i = t.rules,
                                 n = 0,
                                 s = i.length; s > n; n += 1) {
                            for (var o = [], a = i[n].symbolizers, r = 0, h = a.length; h > r; r += 1) a[r].fill && (o[r] = new L.style.Bc.Iv(a[r].fill)),
    ...
    L.Ad = L.Class.extend({
        ...
        L.P.Eg = L.P.ye.extend({
            ...
            aD: function (t, i, e) {
                for (var n = 0; n < t.length; n += 1) for (var s = t[n].ta, o = s.z + e, a = Math.pow(2, e), r = s.x * a, s = s.y * a, h = 0; a > h; h += 1) for (var l = 0; a > l; l += 1) {
    ...
    window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.at = function (t, i, e, n, s) {
        ...
        L.oq = L.zn.extend({
            ...
            zj: function (t, i, e) {
                if (t = this.Zs(i[this.fm], t.ta, e.Hc, 1), (i = i[4]) && i.length) {
                    e = 0;
                    for (var n = i.length; n > e; e += 1) for (var s = i[e].split("-"), o = t[parseInt(s[0])], a = 1, r = s.length; r > a; a += 1) o[parseInt(s[a])].mC = !0
                }
                return t
            },
            dK: function (t, i) {
        ...
        L.Icon = L.Class.extend({
            ...
            _setIconStyles: function (t, i) {
                ...
                t.src && (t.style.background = "url(" + t.src + ") 0% 0% / cover no-repeat"),
    ...
    L.extend(L.GeoJSON, {
        ...
        coordsToLatLngs: function (t, i, e) {
            for (var n, s = [], o = 0, a = t.length; a > o; o++) n = i ? this.coordsToLatLngs(t[o], i - 1, e) : (e || this.coordsToLatLng)(t[o]),
                s.push(n);
            return s
        },
    ...
    L.Marker.include(PointToGeoJSON),
        ...
        L.Edit.Rectangle = L.Edit.SimpleShape.extend({
            ...
            _move: function (t) {
                for (var i, e = this._shape.getLatLngs(), n = this._shape.getBounds(), s = n.getCenter(), o = [], a = 0, r = e.length; r > a; a++) i = [e[a].lat - s.lat, e[a].lng - s.lng],
        ...
        L.Control.Layers = L.Control.extend({
            ...
            _checkDisabledLayers: function () {
                for (var t, i, e = this._form.getElementsByTagName("input"), n = this._map.getZoom(), s = e.length - 1; s >= 0; s--) t = e[s],
                    i = this._layers[t.layerId].layer,
